...
_rejection_tracker: dict[str, dict] = {}
_MAX_REJECTION_TRACKER_ENTRIES = 50
_CONFIDENCE_MULTIPLIER_2ND = 1.30
_CONFIDENCE_MULTIPLIER_3RD = 1.50
...
class SRRejectionFutures(BaseV3Strategy):
    ...
    def compute(self, context: dict) -> dict:
        ...
        if best_signal is None or best_signal["confidence"] < 0.10:
            _rejection_tracker.pop(ticker, None)
